...
전체 323종 중 **46종과 의존 RPM 2종**을 담은 [평가용 묶음](CANDIDATES.md)을
공개했습니다. 바이너리 RPM 48개와 대응 SRPM 34개, 체크섬, 읽기 전용 사전 검사
도구를 포함한 93.2 MiB 파일입니다. 이전 배포본의 대상 24종에서 22종을 추가했습니다.

최종 묶음의 UBI 8 설치·DNF 검사와 Java 8 폰트/JPEG, Python, 로컬 SSH/TLS 등을
포함한 실행 검사 15개가 통과했습니다. 실제 서버 헤더와 비교한 이름 기반 의존성
누락과 downgrade는 0개이며 파일/rich dependency 1,181건은 미판정입니다.
