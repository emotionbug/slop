...
/*
    MTR 0.96 initializes next_sequence to MIN_PORT (33434); the old
    test helper still expected 33000. The first probe uses this sequence,
    so wait for an ICMP packet with this sequence ID.
*/
#define SEQUENCE_NUM 33434
