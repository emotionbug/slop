...
전체 323종 최신화 작업 중 로컬 검증을 통과한 12종과 공식 보조 RPM 1개입니다.
...
각 5개 프로젝트의 SRPM도 포함합니다. 자체 빌드 RPM에는 Red Hat 서명이 없으며,
...
sha256sum -c el8-rpm-candidates-20260924.tar.gz.sha256 &&
tar -xzf el8-rpm-candidates-20260924.tar.gz -C "$bundle_dir" &&
...
압축본은 약 11.3 MiB이며 SHA-256은
`eb2d85bfdcb96c5c225e2f546fbf65534cff84a9e2d9f347bd8ea545d8b1585c`입니다.
